...
for c=1:nsubj
    ...
    switch Group(c)
        case 0
            fmri0{cnt0} = fullfile(fmri_dir,['zscore_' seedname '_', subjname, '.nii']);
            cnt0=cnt0+1;
        case 1
            fmri1{cnt1} = fullfile(fmri_dir,['zscore_' seedname '_', subjname, '.nii']);
            cnt1=cnt1+1;
        case 2
            fmri2{cnt2} = fullfile(fmri_dir,['zscore_' seedname '_', subjname, '.nii']);
            cnt2=cnt2+1;
    end
end
...
%--------------------------------------------------------------------------
clear matlabbatch;
outdir=fullfile(proj_path,'Group_Stat',seedname); mkdir(outdir);
